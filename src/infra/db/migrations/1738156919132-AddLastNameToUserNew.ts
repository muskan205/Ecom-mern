...
export class AddLastNameToUserNew1738156919132 implements MigrationInterface {
    name = 'AddLastNameToUserNew1738156919132'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "seller" ("id" SERIAL NOT NULL, "username" text NOT NULL, "shopName" character varying(255) NOT NULL, "email" character varying(255) NOT NULL, "password" character varying(255) NOT NULL, "role" "public"."seller_role_enum" NOT NULL DEFAULT 'seller', "userId" integer, CONSTRAINT "REL_af49645e98a3d39bd4f3591b33" UNIQUE ("userId"), CONSTRAINT "PK_36445a9c6e794945a4a4a8d3c9d" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "seller_shop" ADD CONSTRAINT "FK_47e849d68589c498c3f4e0855d2" FOREIGN KEY ("ownerId") REFERENCES "seller"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "seller_shop" DROP CONSTRAINT "FK_47e849d68589c498c3f4e0855d2"`);
