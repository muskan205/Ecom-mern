...
export class AddLastNameToUserNew1730960120654 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "order" ADD "order_id" SERIAL NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "order" ADD CONSTRAINT "PK_58998c5eaeaacdd004dec8b5d86" PRIMARY KEY ("order_id")`,
    );
    await queryRunner.query(
      `ALTER TABLE "order" ADD "order_name" text NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "order" ADD "order_date" TIMESTAMP NOT NULL`,
    );
  }
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "order" DROP CONSTRAINT "PK_58998c5eaeaacdd004dec8b5d86"`,
    );
    await queryRunner.query(`ALTER TABLE "order" DROP COLUMN "order_id"`);
    await queryRunner.query(
      `ALTER TABLE "order" ADD "city" character varying NOT NULL`,
    );
